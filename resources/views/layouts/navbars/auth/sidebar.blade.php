<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('home') }}">
            ...
            <span class="ms-3 font-weight-bold">EduResearch</span>
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            @if (Auth::user()->role == 'admin' || Auth::user()->role == 'lecturer')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('publications-list') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link {{ Request::is('feedbacklist', 'Lecturerfeedbacklist') ? 'active' : '' }}"
                    href="{{ Auth::user()->role == 'admin' || Auth::user()->role == 'lecturer' ? route('Lecturerfeedbacklist') : route('feedbacklist') }}">
                    <div
                        class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
